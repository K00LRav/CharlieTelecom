                ...
                <div className="card">
                  ...
                  <div className="card-content">
                    ...
                    <p className="description">
                      ...
                      of information over significant distances by electronic
                      means and refers to all types of voice, data and video
                      transmission. This is a broad term that includes a wide
                      range of information-transmitting technologies and
                      communications infrastructures, such as wired phones;
                      mobile devices, such as cellphones; microwave
                      communications; fiber optics; satellites; radio and
              ...
              <SwiperSlide>
                <div className="card">
                  ...
                  <div className="card-content">
                    ...
                    <p className="description">
                      CCTV means “closed-circuit television” and is commonly
                      known as a video surveillance technology. “Closed-circuit”
                      means broadcasts are limited (closed) to a selected group
                      of monitors, unlike “regular” TV, which can be received
                      and viewed by whoever sets up a reception device.
                    </p>
                ...
                <div className="card">
                  ...
                  <div className="card-content">
                    ...
                    <p className="description">
                      ...
                      broadcast signals (often from communications satellites),
                      which they then retransmit via cables to homes and
                      establishments in the local area subscribing to the
                      service
                    </p>
